...
class SpinController {
    ...
    static async status(req, res) {
        ...
        try {
            ...
            const canSpin = await spin_service_1.SpinService.canSpin(user.id, DEV_WEEK_ID);
    ...
    static async spin(req, res) {
        ...
        try {
            ...
            const allowed = await spin_service_1.SpinService.canSpin(user.id, effectiveWeekId);
            ...
            const result = await spin_service_1.SpinService.spin(user.id, effectiveWeekId);
